...
public class FragID<T extends Texture.Image> extends State {
	...
	public static final Slot<ID> id = new Slot<>(Slot.Type.DRAW, ID.class).instanced(st -> ID.instancer);
	...
	private static final InstancedUniform uid = new InstancedUniform.Vec4("id", p -> {
		...
		return (new float[] { ret.getRed() / 255f, ret.getGreen() / 255f, ret.getBlue() / 255f,
				ret.getAlpha() / 255f });
	}, id);
	...
	public static class ID extends State implements InstanceBatch.AttribState {
		...
		public boolean equals(Object o) {
			return ((o instanceof ID) && (((ID) o).val.equals(this.val)));
		}
	...
	public boolean equals(Object o) {
		return ((o instanceof FragID) && (((FragID) o).image == this.image));
	}
}
