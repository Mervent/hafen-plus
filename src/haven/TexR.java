	...
	public TexR(Resource res, Message buf) {
		...
		while (!buf.eom()) {
			...
			switch (t) {
				...
				case 3:
					int minf = buf.uint8();
					minfilter = new Texture.Filter[] { NEAREST, LINEAR, NEAREST, NEAREST, LINEAR, LINEAR, }[minf];
					mipfilter = new Texture.Filter[] { null, null, NEAREST, LINEAR, NEAREST, LINEAR, }[minf];
					break;
				case 4:
