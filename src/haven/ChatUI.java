...
public class ChatUI extends Widget {
	public static final RichText.Foundry fnd = new RichText.Foundry(
			new ChatParser(TextAttribute.FONT, Text.dfont.deriveFont(10f), TextAttribute.FOREGROUND, Color.BLACK));
		...
		public class NamedMessage extends Message {
			...
			public Text text() {
				...
				if ((r == null) || !nm.equals(cn)) {
					r = fnd.render(RichText.Parser.quote(String.format("%s: %s", nm, text)), w,
