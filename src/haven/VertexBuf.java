...
public class VertexBuf {
	...
	private static Layout fmtfor(AttribData[] allbufs) {
		...
		/*
		 * XXX: This algorithm assumes the maximum and minimum alignment is four, which
		 * is currently true for all vertex buffers, but may have to be adjusted.
		 */
