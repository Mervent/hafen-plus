...
public abstract class Texture implements Disposable {
	...
	public Texture(DataBuffer.Usage usage, VectorFormat ifmt, VectorFormat efmt,
			DataBuffer.Filler<? super Image> init) {
		this.usage = usage;
		this.ifmt = ifmt;
		this.efmt = efmt;
		this.init = init;
	...
	public static class Image<T extends Texture> implements DataBuffer {
		...
		public boolean equals(Image that) {
			return ((this.tex == that.tex) && (this.w == that.w) && (this.h == that.h) && (this.d == that.d)
	...
	public enum Wrapping {
		REPEAT, REPEAT_MIRROR, CLAMP, CLAMP_BORDER, CLAMP_MIRROR,
	}
	...
	public abstract static class Sampler<T extends Texture> implements Disposable {
		...
		private boolean equals(Sampler<?> that) {
			return ((this.tex == that.tex) && (this.magfilter == that.magfilter) && (this.minfilter == that.minfilter)
					&& (this.mipfilter == that.mipfilter) && (this.swrap == that.swrap) && (this.twrap == that.twrap)
					&& (this.rwrap == that.rwrap) && (this.anisotropy == that.anisotropy)
					&& this.border.equals(that.border));
		}
