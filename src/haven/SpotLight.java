...
public class SpotLight extends PosLight {
	...
	/*
	 * XXXRENDER public void enable(GOut g, int idx) { super.enable(g, idx); BGL gl
	 * = g.gl; gl.glLightfv(GL2.GL_LIGHT0 + idx, GL2.GL_SPOT_DIRECTION, dir, 0);
	 * gl.glLightf(GL2.GL_LIGHT0 + idx, GL2.GL_SPOT_EXPONENT, exp);
	 * gl.glLightf(GL2.GL_LIGHT0 + idx, GL2.GL_SPOT_CUTOFF, cut); }
	 *
	 * public void disable(GOut g, int idx) { BGL gl = g.gl;
