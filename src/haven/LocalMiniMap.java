...
public class LocalMiniMap extends Widget {
	...
	private final Map<Pair<Grid, Integer>, Defer.Future<MapTile>> cache = new LinkedHashMap<Pair<Grid, Integer>, Defer.Future<MapTile>>(
			5, 0.75f, true) {
	...
	public boolean mousedown(Coord c, int button) {
		...
		if (gob == null)
			...
			mv.wdgmsg("click", rootpos().add(c), c2p(c).floor(posres), button, ui.modflags(), 0, (int) gob.id,
