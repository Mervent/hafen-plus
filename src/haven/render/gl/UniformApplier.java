...
public interface UniformApplier<T> {
	...
	public static class TypeMapping {
		...
		public static <T> UniformApplier<T> get(Type type, Class<T> cl) {
			/*
			 * XXX: *Should* be synchronized, but doesn't actually need to be. Test and see
			 * if there are performance consequences.
			 */
		...
		private static void apply(BGL gl, Type type, UniformID var, Object val) {
			if (type instanceof Array) {
				...
				/*
				 * XXX? Somewhat unclear if it should be considered okay to leave previous
				 * values unchanged, especially for samplers.
				 */
