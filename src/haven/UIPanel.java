...
public interface UIPanel extends Runnable {
	public static final Cursor emptycurs = Toolkit.getDefaultToolkit().createCustomCursor(TexI.mkbuf(new Coord(1, 1)),
			new java.awt.Point(), "");
	...
	/*
	 * Stuff that is inherited from AWT components, but that have to be declared
	 * since Java is stupid.
	 */
