...
public class Fightsess extends Widget {
	...
	public static final KeyBinding kb_relcycle = KeyBinding.get("fgt-cycle",
			KeyMatch.forcode(KeyEvent.VK_TAB, KeyMatch.C), KeyMatch.S);
	...
	public boolean globtype(char key, KeyEvent ev) {
		// ev = new KeyEvent((java.awt.Component)ev.getSource(), ev.getID(),
		// ev.getWhen(), ev.getModifiersEx(), ev.getKeyCode(), ev.getKeyChar(),
		// ev.getKeyLocation());
		{
			int n = -1;
