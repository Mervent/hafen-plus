...
public class Speedget extends Widget {
	...
	public static final KeyBinding kb_speedup = KeyBinding.get("speed-up",
			KeyMatch.forchar('R', KeyMatch.S | KeyMatch.C | KeyMatch.M, KeyMatch.C));
	public static final KeyBinding kb_speeddn = KeyBinding.get("speed-down",
			KeyMatch.forchar('R', KeyMatch.S | KeyMatch.C | KeyMatch.M, KeyMatch.S | KeyMatch.C));
	public static final KeyBinding[] kb_speeds = { KeyBinding.get("speed-set/0", KeyMatch.nil),
			KeyBinding.get("speed-set/1", KeyMatch.nil), KeyBinding.get("speed-set/2", KeyMatch.nil),
