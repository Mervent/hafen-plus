...
public class GLEnvironment implements Environment {
	...
	private void initialize(GL3 gl) {
		if (debuglog) {
			...
			/*
			 * gl.glDebugMessageControl(GL.GL_DONT_CARE, GL.GL_DONT_CARE,
			 * GL3.GL_DEBUG_SEVERITY_NOTIFICATION, 0, null, 0, false);
			 */
			/*
			 * gl.glDebugMessageControl(GL3.GL_DEBUG_SOURCE_API, GL3.GL_DEBUG_TYPE_OTHER,
			 * GL3.GL_DONT_CARE, 1, new int[] {131185}, 0, false);
			 */
		}
	...
	public void process(GL3 gl) {
		...
		synchronized (submitted) {
			/*
			 * It is important to fetch the submitted renders before prep, so that
			 * additional once aren't submitted during processing that haven't been
			 * prepared.
			 */
