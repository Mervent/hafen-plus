...
public abstract class InstancedUniform {
	...
	public InstancedUniform(Type type, String infix, Slot... deps) {
		...
		attrib = new InstancedAttribute(type, infix) {
			 ...
			 * {InstancedUniform.this.filliarr(g, inst, buf);} public void bindiarr(GOut g,
			 * GLBuffer buf) {InstancedUniform.this.bindiarr(g, buf);} public void
			 * unbindiarr(GOut g, GLBuffer buf) {InstancedUniform.this.unbindiarr(g, buf);}
			 */
		};
	}
